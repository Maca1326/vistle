...
class ReadFOAM: public vistle::Module
{
 ...
 public:
   ...
   private:
      //Parameter
      boost::shared_ptr<vistle::StringParameter> m_casedir, m_patchSelection;
      boost::shared_ptr<vistle::FloatParameter> m_starttime, m_stoptime;
      boost::shared_ptr<vistle::IntParameter> m_timeskip;
      boost::shared_ptr<vistle::IntParameter> m_readGrid, m_readBoundary;
      std::vector<boost::shared_ptr<vistle::StringParameter>> m_fieldOut , m_boundaryOut;
      //Ports
